...
-- c.
	...
	-- 		I tried making it a FOR UPDATE one but it generated an error.

	-- I believe that this FOR UPDATE materialized view is what would be needed to allow this to work. I would
	-- 		also need to not concatenate firstname and lastname into one value, I would need to store birthdate instead of age,
